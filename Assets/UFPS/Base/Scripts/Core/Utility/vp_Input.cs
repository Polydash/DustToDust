...
public class vp_Input : MonoBehaviour
{
	...
	// paths
	protected static string m_FolderPath = "UltimateFPS/Content/Resources/Input";
	protected static string m_PrefabPath = "Assets/UltimateFPS/Content/Resources/Input/vp_Input.prefab";
